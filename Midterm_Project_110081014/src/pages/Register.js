...
// import picture from "../img/add-image.jpg"
    ...
    <div className="Container">
      <div className="Wrapper">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* <button class="btngoogle" id="btngoogle" onClick={handlegoogle}>Sign in with Google</button> */}
          {loading && "Creating your account please wait~"}
          {err && <span>Something wrong please try later</span>}
        </form>
        <p>
